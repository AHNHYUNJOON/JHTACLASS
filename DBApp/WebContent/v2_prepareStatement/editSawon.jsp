...
<table border="1">
	...
	<tr>
		...
		<td>
			<select name="s_dept">
				<option value="영업" <%if(s_addr.equals("영업")){%>selected="true"<%}%>>영업</option>
				<option value="기술" <%if(s_addr.equals("기술")){%>selected="true"<%}%>>기술</option>
				<option value="기획" <%if(s_addr.equals("기획")){%>selected="true"<%}%>>기획</option>
			</select>
		</td>
	</tr>
	<tr>
